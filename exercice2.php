...
class Person {
  ...
  public function __construct(protected string $first_name, 
  ...
  public function afficherInfos(): string {
    return $this->first_name." ".$this->last_name." - ".strval($this->age)." ans";
  }
...
$person1 = new Person("Romain", "Segarizzi", 30);
echo "Information de la personne : ".$person1->afficherInfos();
